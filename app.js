...
async function suivreCommande(){
  ...
  try{
    ...
    result.innerHTML='<div class="suivi-card"><div class="suivi-num">Commande '+c.num+' — '+c.date+'</div><div class="suivi-statut '+(STATUT_CLASS[statut]||'statut-attente')+'">'+(STATUT_ICONS[statut]||'⏳')+' '+statut+'</div><div class="suivi-steps">'+stepsHtml+'</div><div class="suivi-produits">🛍️ '+c.produits+'</div></div>';
  }catch(err){
